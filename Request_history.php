...
<body>
    ...
    <div class="m-3 p-3 rounded" style="border:1px solid gray; height:100%;">
        ...
        <h1 class="text text-center text-primary" style="font-family: 'Playfair Display', serif;">REQUEST RECORDS</h1>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="ViewRequest.php?" method="GET">
                                ...
                                <input type="hidden" value="<?php echo $requestCode ?>" name="code">
